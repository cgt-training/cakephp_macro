<p class="text-right" style="font-size: 22px;"><?= $this->Html->link('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>',
 ['controller'=>'Posts','action' => 'add'],['escape'=>false,'class'=>'AjaxLink']) ?><p>
<table class="table">
<tr class="active">
<th>#</th>
<th>Title</th>
...
<tr>
	...
	<td><?= $this->Html->link('<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>', ['action' => 'edit', $row->id],['escape'=>false,'class'=>'AjaxLink']) ?>&nbsp;&nbsp;
	<?= $this->Form->postLink(
