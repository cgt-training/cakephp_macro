      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <?=$this->Html->link(__('More info <i class="fa fa-arrow-circle-right"></i>'),
            ['controller'=>'BlogPosts','action'=>'todolist'],
            ['escape'=>false,'class'=>'AjaxLink1 small-box-footer'])?>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <?=$this->Html->link(__('More info <i class="fa fa-arrow-circle-right"></i>'),
            ['controller'=>'Products','action'=>'todolist'],
            ['escape'=>false,'class'=>'AjaxLink1 small-box-footer'])?>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <?=$this->Html->link(__('More info <i class="fa fa-arrow-circle-right"></i>'),
            ['controller'=>'Users','action'=>'todolist'],
            ['escape'=>false,'class'=>'AjaxLink1 small-box-footer'])?>
          </div>
        </div>
        <!-- ./col -->
